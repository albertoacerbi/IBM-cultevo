...
```{r 13-4, fig.cap = "For the given parameter ($\\alpha=5$, $\\sigma=3$) the average skill-level increases continously."}
...
```{r 13-8, fig.cap = "The same results as in Figure \\@ref(fig:10-7) but using log on population sizes."}
ggplot(data) + 
